import { View, Text, TextInput, Pressable, RefreshControl, ActivityIndicator, FlatList, Platform } from 'react-native';
...
export default function EmbedDirectoryScreen() {
  ...
  return (
    <View className="flex-1 bg-background h-screen w-full"> 
            ...
            <View className="flex-row gap-2">
                <View className="flex-1 bg-surface rounded-lg flex-row items-center px-3 border border-border h-10">
                    ...
                    <TextInput 
                        ...
                        className={`flex-1 text-text h-full ${Platform.OS === 'web' ? 'outline-none' : ''}`}
                        value={searchQuery}
