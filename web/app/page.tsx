...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#f7f3ef]">
      ...
      {/* Bob University Callout Section */}
      <section className="py-16 sm:py-24 bg-[#2d3e5f]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/3 text-center lg:text-left">
              <Image
                ...
                alt="Bob University - Haircutting Education"
                width={280}
                height={180}
            ...
            <div className="lg:w-2/3">
              <div className="inline-flex items-center gap-2 bg-[#c9a76f]/20 px-4 py-2 rounded-full mb-4">
                <svg className="w-5 h-5 text-[#c9a76f]" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0z" />
                </svg>
                <span className="text-[#c9a76f] font-medium text-sm">Education Platform</span>
              </div>

              <h2 className="text-3xl sm:text-4xl font-serif font-bold text-white mb-4">
                World-Class Haircutting Education
              </h2>

              <p className="text-white/80 text-lg mb-6">
                Bob University is our comprehensive education platform inside The Bob Company app.
                Learn directly from Ray with 14+ hours of professional curriculum, live workshops,
                and hands-on techniques.
              </p>

              <ul className="grid sm:grid-cols-2 gap-4 mb-8">
                <li className="flex items-center gap-3 text-white/90">
                  <svg className="w-5 h-5 text-[#c9a76f] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              ...
              <Link
                href="/subscribe"
                className="inline-flex items-center justify-center bg-[#c9a76f] hover:bg-[#b8965e] text-white font-semibold py-3 px-8 rounded-full transition-colors"
              >
                Start Learning
