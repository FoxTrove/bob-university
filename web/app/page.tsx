      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 pt-16 pb-24 sm:pt-24 sm:pb-32">
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl text-gray-300 max-w-2xl mx-auto mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <a
                href="https://apps.apple.com/app/bob-university/id123456789"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-white text-black font-semibold py-4 px-8 rounded-xl hover:bg-gray-100 transition-colors"
              >
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {FEATURES.map((feature, index) => (
              <div
                key={index}
                className="bg-surface rounded-2xl p-6 border border-gray-800 hover:border-primary/50 transition-colors"
              >
      ...
      <section className="py-16 sm:py-24 border-t border-gray-800">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/subscribe"
              className="inline-flex items-center justify-center bg-primary hover:bg-primary/90 text-white font-semibold py-4 px-8 rounded-xl transition-colors text-lg"
            >
              View Plans & Pricing
            </Link>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center bg-surface hover:bg-surface/80 text-white font-semibold py-4 px-8 rounded-xl border border-gray-700 transition-colors text-lg"
            >
              Learn More
            </a>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-2">
              <span className="text-2xl font-serif font-bold text-primary">B</span>
              <span className="text-white font-semibold">The Bob Company</span>
            </div>

            <div className="flex items-center gap-6 text-sm text-gray-400">
              <a href="https://thebobcompany.com/privacy" className="hover:text-white transition-colors">
                Privacy Policy
              </a>
              <a href="https://thebobcompany.com/terms" className="hover:text-white transition-colors">
                Terms of Service
              </a>
              <a href="mailto:support@thebobcompany.com" className="hover:text-white transition-colors">
                Support
              </a>
            </div>
